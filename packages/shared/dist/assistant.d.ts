...
export declare const KNOWLEDGE_OPEN_TAG = "<kienthucchung>";
export declare const KNOWLEDGE_CLOSE_TAG = "</kienthucchung>";
/**
 ...
 */
export declare function parseReplySegments(text: string): ReplySegment[];
