 ...
 */
export const REGION_PROVINCE_CODES = ['48', '51', '52', '56', '66', '68'];
...
export const REGION_PROVINCE_NAMES = {
    '48': 'Đà Nẵng',
    '51': 'Quảng Ngãi',
    '52': 'Gia Lai',
    '56': 'Khánh Hòa',
...
export function isRegionProvince(code) {
    return typeof code === 'string' && REGION_PROVINCE_CODES.includes(code);
}
